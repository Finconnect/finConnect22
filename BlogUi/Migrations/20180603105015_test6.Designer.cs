...
namespace BlogUi.Migrations
{
    ...
    [Migration("20180603105015_test6")]
    partial class test6
    {
            ...
            modelBuilder.Entity("BlogUi.Models.Agent", b =>
                {
                    ...
                    b.Property<int?>("TransacrtionAgentid");
                    ...
                    b.HasIndex("TransacrtionAgentid");
            ...
            modelBuilder.Entity("BlogUi.Models.Agent", b =>
                {
                    ...
                    b.HasOne("BlogUi.Models.TransacrtionAgent")
                        .WithMany("agent")
                        .HasForeignKey("TransacrtionAgentid");
                });
